...
void AFinalProjectCharacter::UpdateAnimation()
{
...
void AFinalProjectCharacter::Tick(float DeltaSeconds)
{
...
void AFinalProjectCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindTouch(IE_Pressed, this, &AFinalProjectCharacter::TouchStarted);
	InputComponent->BindTouch(IE_Released, this, &AFinalProjectCharacter::TouchStopped);
}
...
void AFinalProjectCharacter::TouchStarted(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	// jump on any touch
	Jump();
}

void AFinalProjectCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	StopJumping();
}

void AFinalProjectCharacter::UpdateCharacter()
{
